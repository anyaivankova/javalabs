...
class Sentense {
    private ArrayList<SentenceElement> wordList;

    public Sentense(String someLine) {
        wordList = splitToWords(someLine);
    }

    private ArrayList<SentenceElement> splitToWords(String someLine) {
        String[] splitLine = someLine.split(" ");
        ArrayList<SentenceElement> resultWordList = new ArrayList<>();
        String tempWord;
        String lastLetter;
        String filteredWord;
